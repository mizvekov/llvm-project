...
// expected-error-re@-1 {{type {{'std::pair<string, string>' (aka 'std::pair<std::string, std::string>')|'std::pair<std::string, std::string>'}} of non-type template parameter is not a structural type}}
