...
MultiLevelTemplateArgumentList Sema::getTemplateInstantiationArgs(
    const NamedDecl *ND, bool Sugared, const TemplateArgumentList *Innermost,
...
namespace {
  ...
  public:
    ...
    QualType BuildSubstTemplateTypeParmType(
        TypeLocBuilder &TLB, bool SuppressObjCLifetime, bool Sugared,
...
ExprResult TemplateInstantiator::transformNonTypeTemplateParmRef(
  ...
  // FIXME: Don't put subst node on sugared replacement.
