  ...
  if (isa<TemplateTemplateParmDecl>(Template)) {
    ...
    if (Keyword != ElaboratedTypeKeyword::None &&
      ...
      SemaRef.Diag(TemplateLoc, diag::err_tag_reference_non_tag)
          << AliasTemplate << Sema::NTK_TypeAliasTemplate
          << llvm::to_underlying(
                 ElaboratedType::getTagTypeKindForKeyword(Keyword));
...
DeclResult Sema::ActOnClassTemplateSpecialization(
  ...
  TypeSourceInfo *WrittenTy = Context.getTemplateSpecializationTypeInfo(
      ...
      SS.getWithLocInContext(Context), /*TemplateKeywordLoc=*/SourceLocation(),
...
static bool isEnableIf(NestedNameSpecifierLoc NNS, const IdentifierInfo &II,
  ...
  auto EnableIfTSTLoc = NNS.getTypeLoc().getAs<TemplateSpecializationTypeLoc>();
