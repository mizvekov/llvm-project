...
public:
  ...
  NestedNameSpecifier *transform(NestedNameSpecifier *NNS, bool &OutChanged) {
    ...
    case NestedNameSpecifier::Super:
      return NNS;
    case NestedNameSpecifier::Identifier: {
      NNS = transform(NNS->getPrefix(), Changed);
      if (!Changed)
        return NNS;
      OutChanged = true;
      return NestedNameSpecifier::Create(SemaRef.Context, NNS,
                                         NNS->getAsIdentifier());
    }
    case NestedNameSpecifier::TypeSpec:
    case NestedNameSpecifier::TypeSpecWithTemplate: {
      ...
      if (const auto *ET = dyn_cast<ElaboratedType>(T)) {
        NNS = transform(ET->getQualifier(), Changed);
      ...
      return NestedNameSpecifier::Create(
          SemaRef.Context, NNS, K == NestedNameSpecifier::TypeSpecWithTemplate,
          T);
    }
    }
    llvm_unreachable("Unknown NestedNameSpecifier Kind");
